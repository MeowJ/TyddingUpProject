...
class vision:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber('/panda/usbcam/image_raw', Image, self.image_callback)
...
#************************************************************************************************************************************
      ...
      # Visualization of the results of a detection.
        ...
        # cv2.putText(image_np, "Object centeral position: (" + str(int(x)) + " , " + str(int(y)) + ")", (20, 20),
        ...
        # object_class = classes[0][0]
        # print(object_class)
        # robot_target_o = float(target_slope)
        # robot_speed = float(speed)
        # print('Publishing eva_move_to...')
        pub = rospy.Publisher('arm_move_to', Float64MultiArray, queue_size=1)
        r = rospy.Rate(2000)  # hz
        if not rospy.is_shutdown():
          target_coords.data = [x, y]
          # target_coords.data = [robot_target_x, robot_target_y, object_class, robot_target_o,
          #                       robot_speed]
